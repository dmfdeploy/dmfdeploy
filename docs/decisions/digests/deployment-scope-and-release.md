...
- Profile 3 — `<env>` and successors (live lab / regression reference): explicitly not a release profile; allowed to depend on operator-specific credentials. (ADR-0031 Decision)
